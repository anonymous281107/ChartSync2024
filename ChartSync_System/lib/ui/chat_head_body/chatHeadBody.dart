...
import 'package:floatingbubble/data/chart_data.dart';
...
class _ChatHeadBodyState extends State<ChatHeadBody> {
  ...
  void initState() {
    ...
    for (var loopIndex = 0;
      ...
      var listOfWidgets = currentViewComponent(
        widget.reorderList[loopIndex].viewType,
        randomItem,
      );

      for (var widget in listOfWidgets) {
        pageViewChildren.add(widget);
      }
  ...
  List<Widget> currentViewComponent(
      ViewType viewType, int randomlySelectedIndex) {
    ...
    switch (viewType) {
      ...
      case ViewType.custom:
        ...
        for (int index = 0;
            index < customChartData[randomlySelectedIndex].length;
            index++) {
          test.add(
            Charts(
              key: UniqueKey(),
              ...
              toggleFilterDisplay: toggleFilterDisplay,
              isFilterEnabled: true,
              chartData: customChartData[randomlySelectedIndex][index],
            ),
          );
        }
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      CustomButton(
                        hasBoxShadow: false,
                        onPressed: () =>
                            changePageViewIndex(true, _controller.page),
                      ...
                      CustomButton(
                        hasBoxShadow: false,
                        onPressed: () =>
                            changePageViewIndex(false, _controller.page),
                        borderRadius: Sizes.RADIUS_80,
                        title: 'Next',
